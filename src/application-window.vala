...
namespace Proximity {
    ...
    public class ApplicationWindow : Gtk.ApplicationWindow {
        ...
        public void on_open_browser () {
            ...
            string[] spawn_args = {"/usr/bin/chromium", "--temp-profile", "--ignore-certificate-errors", "--test-type", "--install-autogenerated-theme=216,239,217", "--proxy-server=" + this.proxy_settings.local_proxy_address ()};
